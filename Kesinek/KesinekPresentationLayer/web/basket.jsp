    ...
    <html>
        ...
        <body>
            ...
            <rich:panel>
                ...
                <h:form>
                    <rich:dataGrid var="product" value="#{BasketBean.productDataModel}" columns="3" elements="9">
                        <rich:panel bodyClass="pbody">
                            ...
                            <h:panelGrid columns="2">
                                ...
                                <h:commandLink value="Remove from basket" action="#{ProductBean.removeFromBasket}">
                                    <f:param name="productID" value="#{product.productItemID}" />
                                </h:commandLink>
                            </h:panelGrid>
                        </rich:panel>
                    ...
                    <h:commandButton value="Make order" action="#{BasketBean.makeOrder}" />
                </h:form>
            </rich:panel>
        </body>
    </html>
